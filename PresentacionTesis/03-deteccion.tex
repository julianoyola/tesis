...
\begin{frame}
	...
	\begin{figure}[h]
		...
		\caption{\textbf{Izquierda:} Fotografía original de las monedas. \textbf{Derecha:} Arreglo acumulador de votos. }
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\centering
		...
		\caption{\textbf{Izquierda:} Fotografía original de varicela. \textbf{Derecha:} Arreglo acumulador con votos sumados. }
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Se aplica CHT: Circular Hough Transform. Ecuación $(x-x0)^2 + (y-y0)^2 = r^2$ \\
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{Detección de vesículas con diferentes radios. \textbf{Izq:} Bordes detectados. \textbf{Centro:} Detección de vesículas con radio radio = 40. \textbf{Der:} Detección de vesículas con radio = 43. }
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption{Detección de vesículas con diferentes radios. \textbf{Izquierda:} radio = 23. \textbf{Derecha:} radio = 24. }
	\end{figure}
\end{frame}

\begin{frame}
	\frametitle{Eliminación de círculos redundantes}
	\begin{figure}[!h]
		\centering
			...
			\caption{\textbf{Izq:} Detección de círculos redundantes con $k = max(r1, r2)$. \textbf{Der:} Detección de círculos redundantes con $k = r1 + r2$.}
	\end{figure}
\end{frame}
...
\begin{frame}
	\frametitle{Comparación de los espacios de color L*a*b y YCbCr}
		\begin{figure}[h!]
		\centering
		\tiny
		\subfigure[]
